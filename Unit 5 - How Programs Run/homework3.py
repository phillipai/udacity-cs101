...
def involved(courses, person):
    elements = {}
    for dates in courses:
        for classes in courses[dates]:
            for property in courses[dates][classes]:
                if courses[dates][classes][property] == person:
                    if dates not in elements:
                        elements[dates] = [classes]
                    else:
                        elements[dates].append(classes)
